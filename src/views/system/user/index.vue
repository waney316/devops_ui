  ...
  <div class="app-containter">
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column label="关联角色" prop="is_superuser">
          <template slot-scope="{ row }">
            <el-tag
        ...
        <el-table-column label="在职状态" prop="is_active">
          <template slot-scope="{ row }">
            <el-switch v-model="row.is_active" size="mini" disabled
              >否</el-switch
            >
          </template>
        </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="职位描述" prop="position">
              <el-input
    ...
    <el-dialog title="用户详情" :visible.sync="dialogDetailVisible">
      <el-form :model="Detailform" size="mini">
        <el-row :gutter="24">
          <el-col :span="8">
            <el-form-item label="ID" label-width="120">
              <el-input v-model="Detailform.id" autocomplete="off" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
        ...
        <el-row :gutter="24">
          <el-col :span="8">
            <el-form-item label="邮箱" label-width="120">
              <el-input v-model="Detailform.email" autocomplete="off" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="手机" label-width="120">
              <el-input v-model="Detailform.phone" autocomplete="off" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="职位" label-width="120">
              <el-input v-model="Detailform.position" autocomplete="off" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
